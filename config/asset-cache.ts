...
const HASHED_ASSET_MAX_AGE_MS = HASHED_ASSET_MAX_AGE_SECONDS * 1000;

/** HTTP Cache-Control for hashed admin chunks and uniquely named uploads. */
const HASHED_ASSET_CACHE_CONTROL = `public, max-age=${HASHED_ASSET_MAX_AGE_SECONDS}, immutable`;
 ...
 */
function setHashedAssetCacheHeaders(res: ServerResponse): void {
